...
//function that initiating template plugins on window.load event
    function documentReadyInit() {
        ...
        $('form.contact-form').on('submit', function (e) {
            ...
            var ajax = jQuery.post("https://belgilabs.com/api/v1/mail/send", request)
                .done(function (data) {
                    $($form).find('[type="submit"]').attr('disabled', false).parent().append('<div class="contact-form-respond color-main mt-20">' + 'Message recieved successfully' + '</div>');
                    //cleaning form
